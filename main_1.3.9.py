...
# text_games
# version 1.3.9
# description: added flavor, items, and quarters activities, adjusted visible items; updated elevators
    ...
    if choice == '1':
        ...
        things.append({'name': 'digipad3', 'prefix': 'a',
                       'description': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates.'
                                      ...
                                      '\n\tOthers just collapsed. But some went into zombie mode and started attacking. -B',
        ...
        events.insert(10, {'id': 10, 'done': False, 'room': 999, 'item_name': 'digipad3',
                          'first_time_text': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates.'
                                      ...
                                      'But some went into zombie mode and started attacking. -B',
                          'already_done_text': 'The digipad reads:'
                                      '\n\tI saw Jackson from Combat Services drop dead. Once she did, a jade crystal coating formed over her skin.\n\tOthers just collapsed.'
                                      'But some went into zombie mode and started attacking. -B'})
