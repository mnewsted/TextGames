...
# text_games
# version 1.2.10.4
# description added combat miss chance, damage range, creature attack, player wellness, player death
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        creatures.append({ 'id': 0, 'name': 'Monster', 'description': 'The monster is about 7 feet tall, covered in yellow fur, and shows sharp teeth and claws.', 'room': 0, 'max_hp': 100, 'current_hp': 100, 'is_dead': False, 'is_hostile': False, 'status_neutral': 'It isn\'t interested in you.', 'status_hostile': 'It\'s very mad at you.', 'damage': 30, 'hit_bonus': 20} )
