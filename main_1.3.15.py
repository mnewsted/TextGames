...
# text_games
# version 1.3.15
# description: added creature description visible upon first seen, creature dead desc
...
def creature_wellness(current, max):
    ...
    if percentage > 75:
        ...
        return "appears to be in some pain."
    elif percentage > 25:
...
def do_event(event_id, current_room):
    ...
    if game_choice == '1':
        ...
        if event_id in [0, 5, 6, 7, 10, 14, 16, 18, 19, 22, 27, 36, 37]:
            print(events[event_id]['first_time_text'])
            events[event_id]['done'] = True
        # use stimpack
        if event_id in [1]:
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        outro_text = ('The escape pod instruments light up, and you feel the machinery around the pod shifting, preparing for launch. You buckle into a seat as you watch the launch bay doors open outside the pod.'
        ...
        world.insert(2, {'visible': True, 'name': 'Back hallway', 'prefix': 'in the',
                         ...
                         'exits': {'w': 1, 'n': 3}})
        world.insert(3, {'visible': True, 'name': 'Storage nook', 'prefix': 'in a',
                         'desc': 'The only exit from this room is south.',
                         'exits': {'s': 2}})
        world.insert(4, {'visible': True, 'name': 'Detention Level Elevator Bay (to Main Deck)', 'prefix': 'at the',
                         'desc': 'The elevator goes up to the Main Deck, but it requires a keycard to activate it. The detention hallway is to the east.',
                         'exits': {'e': 1}})
        world.insert( 5, {'visible': False, 'name': 'Main Deck Elevator Bay 5 (to Detention Level)', 'prefix': 'at',
        ...
        world.insert( 6, {'visible': True, 'name': 'Main Deck Security Desk', 'prefix': 'at a',
                          ...
                          'exits': {'e': 5, 's': 7, 'w': 8}})
        world.insert( 7, {'visible': True, 'name': 'Main Deck Elevator Bay 4 (to Engine Room)', 'prefix': 'at',
        ...
        world.insert( 8, {'visible': True, 'name': 'Walkway', 'prefix': 'in the',
                          ...
                          'exits': {'e': 6, 'n': 9, 'w': 10}})
        world.insert( 9, {'visible': True, 'name': 'Main Deck Elevator Bay 3 (to Hangar)', 'prefix': 'at',
        ...
        world.insert( 10, {'visible': True, 'name': 'Wide hallway', 'prefix': 'in the',
                          ...
                          'exits': {'e': 8, 's': 11, 'w': 12}})
        world.insert( 11, {'visible': True, 'name': 'Main Deck Elevator Bay 2 (to Armory)', 'prefix': 'at',
                          ...
                          'exits': {'n': 10}})
        world.insert( 12, {'visible': True, 'name': 'Funneling hallway', 'prefix': 'in a',
                          ...
                          'exits': {'e': 10, 'w': 13}})
        world.insert( 13, {'visible': True, 'name': 'Main Deck Elevator Bay 1 (to Quarters)', 'prefix': 'at',
                          'desc': 'The elevator goes down to Crew Quarters, but it requires a keycard to activate it. To the east is a widening hallway.', 'exits': {'e': 12}})
        world.insert( 14, {'visible': True, 'name': 'Engine Room Elevator Bay (to Main Deck)', 'prefix': 'at the',
        ...
        world.insert( 18, {'visible': True, 'name': 'South fuel cell storage', 'prefix': 'in the',
                           ...
                           'exits': {'n': 15}})
        world.insert( 19, {'visible': True, 'name': 'Hangar Elevator Bay (to Main Deck)', 'prefix': 'at the',
        ...
        world.insert( 22, {'visible': True, 'name': 'Escape pod L07', 'prefix': 'in', 'desc': 'This small pod is cozy. The exit to the Hangar is to the northeast.',
                           'exits': {'ne': 20}})
        world.insert( 23, {'visible': True, 'name': 'Armory Elevator Bay (to Main Deck)', 'prefix': 'at the',
        ...
        world.insert( 27, {'visible': True, 'name': 'Armory supply room', 'prefix': 'in the',
                           ...
                           'exits': {'w': 25}})
        world.insert( 28, {'visible': False, 'name': 'Quarters Elevator Bay 3 (to Main Deck)', 'prefix': 'at',
        ...
        world.insert( 33, {'visible': True, 'name': 'Quarters Elevator Bay 1 (to Bridge)', 'prefix': 'at',
                           'desc': 'This elevator goes up to the Bridge, but it requires a keycard to activate it. To the south is the observation deck.',
                           'exits': {'s': 32}})
        world.insert( 34, {'visible': True, 'name': 'Quarters Elevator Bay 2 (to Mess & Medical)', 'prefix': 'at',
                           ...
                           'exits': {'n': 32}})
        world.insert( 35, {'visible': True, 'name': 'Mess Hall and Medical Services Elevator Bay (to Quarters)', 'prefix': 'at the',
        ...
        world.insert( 36, {'visible': True, 'name': 'Medical Services A', 'prefix': 'in',
                           'desc': 'There is a small waiting area and a desk. To the north is an elevator bay. East is a room labeled Medical Services B.',
                           'exits': {'n': 35, 'e': 37}})
        world.insert( 37, {'visible': True, 'name': 'Medical Services B', 'prefix': 'in',
        ...
        world.insert( 41, {'visible': True, 'name': 'Storage and cleaning closet', 'prefix': 'in the',
                           ...
                           'exits': {'w': 38}})
        world.insert( 42, {'visible': True, 'name': 'Bridge Elevator Bay (to Quarters)', 'prefix': 'at the',
        ...
        world.insert( 43, {'visible': True, 'name': 'Bridge Security Desk', 'prefix': 'at the',
                           ...
                           'exits': {'e': 45, 's': 42}})
        world.insert( 44, {'visible': False, 'name': 'Bridge', 'prefix': 'on the',
        ...
        things.append({'name': 'stimpack', 'prefix': 'a', 'description': 'A small vial of clear liquid has a tiny needle on one end and a red heart decal on the side.',
                       'location': 3, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'breathing mask', 'prefix': 'a', 'description': 'The compact device looks like it would fit nicely on your face if you pick it up or use it.',
                       'location': 3, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        ...
        things.append({'name': 'wrench', 'prefix': 'a',
                       ...
                       'location': 17, 'on_person': False, 'moveable': True, 'is_weapon': True, 'damage': 20, 'hit_bonus': 30})
        things.append({'name': 'fuel cell', 'prefix': 'a',
                       ...
                       'location': 16, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'corpse', 'prefix': 'a',
                       ...
                       'location': 10, 'on_person': False, 'moveable': False, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        ...
        things.append({'name': 'allen claw', 'prefix': 'an', 'description': 'This shiny, angular piece of metal appears to have been fashioned for a specific purpose.',
                        'location': 41, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'smooth bar', 'prefix': 'a', 'description': 'This rod is painted orange. It has fittings on both ends.',
                        'location': 31, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'gummy grip', 'prefix': 'a', 'description': 'The short pipe has a cushioned yet tackified surface.',
                        'location': 27, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'dented tricorder', 'prefix': 'a', 'description': 'This banged-up scanner must be good for something. It still beeps!',
                        'location': 32, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'lockbox', 'prefix': 'a', 'description': 'There are cryptic symbols on this oblong box. The lid is fastened tight, but a square keyhole looks promising.',
                        'location': 18, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'scalpel', 'prefix': 'a',
                       ...
                       'location': 37, 'on_person': False, 'moveable': True, 'is_weapon': True, 'damage': 25,
                       'hit_bonus': 15})
        things.append({'name': 'fallen soldier', 'prefix': 'a',
                       'description': 'This dead crewmate is bent backwards, leaning on the countertop. They have the insignia and fatigues of a tactical combat specialist. '
                                      'Unlike the other bodies you encountered, this one seems frozen in shock, face up with eyes and mouth wide open.',
                       'location': 39, 'on_person': False, 'moveable': False, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'large stimpack', 'prefix': 'a', 'description': 'This device has 3 compact barrels of clear liquid that funnel into a small needle. You are comforted by the cheerful red heart logo on the top, '
                                                                               'and the encouraging label that reads, "Massive vitality boost."',
                       'location': 36, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        ...
        things.append({'name': 'hot sauce', 'prefix': 'a', 'description': 'This small bottle has a picture of a burning crescent-shaped pepper. "One drop\'ll do ya!"',
                        'location': 40, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'mayonnaise', 'prefix': 'a', 'description': 'The large jar of eggy, white, goop is still half-full.',
                        'location': 40, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'pear powder', 'prefix': 'a', 'description': 'A hand-written label on this see-through bag describes the sparkly, yellow granules inside the flavor pouch.',
                        'location': 40, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        ...
        things.append({'name': 'phaser', 'prefix': 'a',
                       ...
                       'location': 26, 'on_person': False, 'moveable': True, 'is_weapon': True, 'damage': 25, 'hit_bonus': 40})
        things.append({'name': 'wound salve', 'prefix': 'a', 'description': 'The label on the opaque brown jar reads, "Apply liberally to cuts, welts, and lacerations." Inside is a substance that looks like pink jelly.',
                       'location': 27, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'digipad8', 'prefix': 'a',
                        # update this text
                       'description': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates.'
                                       '\n\tThose infecteds, zombies, whatever--they do not stop.'
                                       '\n\tMe and Barb held off 6 of them in the mess hall. Don\'t know why but food seemed to slow them down.'
                                       '\n\tOr maybe it just distracted them. Hope somebody sees this. -X',
                      'location': 24, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'code generator', 'prefix': 'a',
                       ...
                       'location': 44, 'on_person': False, 'moveable': False, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'lockdown console', 'prefix': 'the',
        ...
        things.append({'name': 'dead crewmate', 'prefix': 'a',
                       ...
                       'location': 32, 'on_person': False, 'moveable': False, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'dead engineer', 'prefix': 'a',
                       ...
                       'location': 15, 'on_person': False, 'moveable': False, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        ...
        events.insert(3, {'id': 3, 'done': False, 'room': 999, 'item_name': 'keycard',
                          'first_time_text': 'As the guard falls to the floor, a keycard falls from its pocket.', 'already_done_text': 'Judging by its markings, this seems like it would be useful at the Detention Elevator Bay.'})
        ...
        events.insert(4, {'id': 4, 'done': False, 'room': 999, 'item_name': 'breathing mask',
                          'first_time_text': 'The mask fits snugly on your face.', 'already_done_text': 'The mask fits snugly on your face.'})
        ...
        events.insert(7, {'id': 7, 'done': False, 'room': 999, 'item_name': 'wrench',
                          'first_time_text': 'You heave the wrench in a fearsome arc.', 'already_done_text': 'You heave the wrench in a fearsome arc.'})
        ...
        events.insert(12, {'id': 12, 'done': False, 'room': 999, 'item_name': 'mess keycard',
                          'first_time_text': 'As the zombie falls to the floor, a keycard falls from its pocket.', 'already_done_text': 'Judging by its markings, this seems like it would be useful at the Mess & Medical Elevator Bay.'})
        ...
        events.insert(13, {'id': 13, 'done': False, 'room': 39, 'item_name': 'scalpel',
                          'first_time_text': 'After gathering resolve, you gently cut an eye out of the fallen soldier and slide it in your pocket. Yuck.', 'already_done_text': 'Haven\'t you butchered enough already?'})
        events.insert(14, {'id': 14, 'done': False, 'room': 999, 'item_name': 'scalpel',
                          'first_time_text': 'You slice with the scalpel.', 'already_done_text': 'You slice with the scalpel.'})
        events.insert(15, {'id': 15, 'done': False, 'room': 999, 'item_name': 'large stimpack',
                          'first_time_text': 'You jab the large stimpack into your thigh. Intense heat surges into your body, and you feel much better.',
        ...
        events.insert(17, {'id': 17, 'done': False, 'room': 11, 'item_name': 'soldier eye',
                          'first_time_text': 'You hold the clammy eyeball up to the retina scanner. After repositioning it, the control panel beeps twice '
                                        'and displays, "ARMORY ACCESS GRANTED." You can now use the elevator!', 'already_done_text': 'This elevator is already accessible.'})
        ...
        events.insert(27, {'id': 27, 'done': False, 'room': 999, 'item_name': 'digipad8',
                          ...
                          'already_done_text': 'The digipad reads:'
                                       ...
                                       '\n\tMe and Barb held off 6 of them in the mess hall. Don\'t know why but food seemed to slow them down.'
                                       '\n\tOr maybe it just distracted them. Hope somebody sees this. -X'})
        events.insert(28, {'id': 28, 'done': False, 'room': 999, 'item_name': 'allen claw',
                          'first_time_text': 'The allen claw, smooth bar, and gummy grip fit together with a satisfying snap. You\'ve made the override lever!', 'already_done_text': 'Nothing happens.'})
        events.insert(29, {'id': 29, 'done': False, 'room': 999, 'item_name': 'smooth bar',
                          'first_time_text': 'The allen claw, smooth bar, and gummy grip fit together with a satisfying snap. You\'ve made the override lever!', 'already_done_text': 'Nothing happens.'})
        events.insert(30, {'id': 30, 'done': False, 'room': 999, 'item_name': 'gummy grip',
                          'first_time_text': 'The allen claw, smooth bar, and gummy grip fit together with a satisfying snap. You\'ve made the override lever!', 'already_done_text': 'Nothing happens.'})
        ...
        events.insert(34, {'id': 34, 'done': False, 'room': 21, 'item_name': 'launch controls',
                          'first_time_text': 'You activate the launch controls.', 'already_done_text': 'You activate the launch controls.'})
        events.insert(35, {'id': 35, 'done': False, 'room': 22, 'item_name': 'launch console',
                          'first_time_text': 'You activate the launch console.', 'already_done_text': 'You activate the launch console.'})
        ...
        creatures.append({'id': 0, 'name': 'Prison guard',
                          ...
                          'status_neutral': 'It isn\'t interested in you.', 'status_hostile': 'It\'s very mad at you.',
                          'damage': 10, 'hit_bonus': 10, 'attack_chance': 65, 'is_fatigued': False, 'death_event': 3, 'was_seen': False,
                          'dead_description': 'The lifeless body of the prison guard is a foreboding sight.' })
        creatures.append({'id': 1, 'name': 'Spry zombie',
                          'description': 'This zombified crewmate is short, lithe, and unpredictable. It has that familair green skin and murky eyes. Blood and bits of flesh are visible on the tips of its fingers.',
                          'room': 30, 'max_hp': 60, 'current_hp': 60, 'is_dead': False, 'is_hostile': True,
                          'status_neutral': 'It isn\'t interested in you.', 'status_hostile': 'It\'s very mad at you.',
                          'damage': 15, 'hit_bonus': 15, 'attack_chance': 70, 'is_fatigued': False, 'death_event': 12, 'was_seen': False,
        ...
        creatures.append({'id': 2, 'name': 'Hulking guard',
                          ...
                          'damage': 20, 'hit_bonus': 5, 'attack_chance': 60, 'is_fatigued': False, 'death_event': 21, 'was_seen': False,
        ...
        creatures.append({'id': 3, 'name': 'Captain',
                          ...
                          'damage': 15, 'hit_bonus': 20, 'attack_chance': 80, 'is_fatigued': False, 'death_event': 31, 'was_seen': False,
