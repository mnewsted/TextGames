...
# text_game
# version 1.2.8
# added multi word command processing
# added rooms and puzzles
...
def show_help():
    ...
    print('')
    print('You can type the name of the item you want to use, examine, take, or drop.')
    #print('Note: If you don\'t say what you want to When typing a command, enter one action word then press ENTER.')
    print('Example: If you want to use the apple, you can type \'use apple\' or \'use.\'')
...
def show_intro():
    ...
    print('Look around and use things. If the way forward is not clear, keep looking. And using.')
    #print('Nothing in the game can hurt you, but not everything is needed to escape.')
    print('You must escape and get back to reality!')
    print('')
...
world.insert(4, { 'visible': True, 'name': 'Park', 'prefix': 'at the', 'desc': 'The grassy clearing at the end of the road is accented by a few tall trees. Part of the grass is bare along the southern edge, and it contains a strange etching of a house and a winged creature. The street is at the north end of the park, a trail leads through the trees to the west, and a meadow is to the east.', 'exits': {'n':3, 'e':10, 'w':11} })
...
world.insert(13, { 'visible': False, 'name': 'Winding passageway', 'prefix': 'in a', 'desc': 'This jaunty tunnel is dimly lit by bioluminescent lichen. So pretty! The open iron gate is at the south end of the passage. As it bends to the east, it goes deeper and deeper into the earth.', 'exits': {'s': 12, 'e': 14 }})
world.insert(14, { 'visible': True, 'name': 'Subbasement', 'prefix': 'in the', 'desc': 'This tiny, chilly room opens west to a winding passageway. There\'s a trick one-way trapdoor in the ceiling, which you can access using handholds cut into the wall.', 'exits': {'w': 13, 'u': 6 }})
...
# find way to include starting_room and exit_room in world data source?
starting_room = 0
exit_room = 5
