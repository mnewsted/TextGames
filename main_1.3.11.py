...
# text_games
# version 1.3.11
# description: added armory level events & items
...
def do_event(event_id, current_room):
    ...
    if game_choice == '1':
        ...
        if event_id in [0, 5, 6, 7, 10, 14, 16, 18, 19, 22]:
            print(events[event_id]['first_time_text'])
            events[event_id]['done'] = True
        # use stimpack
        if event_id in [1]:
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        things.append({'name': 'allen claw', 'prefix': 'a', 'description': 'This shiny, angular piece of metal appears to have been fashioned for a specific purpose.',
        ...
        events.insert(9, {'id': 9, 'done': False, 'room': 13, 'item_name': 'quarters keycard',
                          'first_time_text': 'The keycard fits nicely into the elevator console. You can now use the elevator!', 'already_done_text': 'This elevator is already accessible.'})
        events.insert(10, {'id': 10, 'done': False, 'room': 999, 'item_name': 'digipad3',
                          'first_time_text': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates.'
        ...
        events.insert(19, {'id': 19, 'done': False, 'room': 999, 'item_name': 'digipad5',
                          'first_time_text': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates.'
                                        '\n\tNote line 1'
                                        '\n\tNote line 2',
                          'already_done_text': 'The digipad reads:'
