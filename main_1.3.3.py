...
# text_games
# version 1.3.3
# description: added more rooms to space adventure
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        world.insert(4, {'visible': True, 'name': 'Detention Level Elevator Bay', 'prefix': 'at the',
                         ...
                         'exits': {'e': 1, 'u': 5}})
        world.insert( 5, {'visible': True, 'name': 'Main Deck Elevator Bay 5', 'prefix': 'at',
        ...
        world.insert( 6, {'visible': True, 'name': 'Main Deck Security Desk', 'prefix': 'at a',
                          ...
                          'exits': {'e': 5, 's': 7, 'w': 8}})
        world.insert( 7, {'visible': True, 'name': 'Main Deck Elevator Bay 4', 'prefix': 'at', 'desc': 'The elevator goes down to the Engine Room. To the north is a security checkpoint.',
                          'exits': {'n': 6, 'd': 14}})
        world.insert( 8, {'visible': True, 'name': 'Walkway', 'prefix': 'in the',
                          ...
                          'exits': {'e': 6, 'n': 9, 'w': 10}})
        world.insert( 9, {'visible': True, 'name': 'Main Deck Elevator Bay 3', 'prefix': 'at', 'desc': 'The elevator goes down to the Hangar. To the south is a walkway.',
                          'exits': {'s': 8, 'd': 19}})
        ...
        world.insert( 11, {'visible': True, 'name': 'Main Deck Elevator Bay 2', 'prefix': 'at',
                           'desc': 'The elevator goes down to the Armory. To the north is a wide, branching hallway.', 'exits': {'d': 23, 'n': 10}})
        ...
        world.insert( 16, {'visible': True, 'name': 'North fuel cell storage', 'prefix': 'in the', 'desc': 'This room is filled with unused fuel cells. The only exit is to the south.',
                           'exits': {'s': 15}})
        world.insert( 17, {'visible': True, 'name': 'Engine Equipment Room', 'prefix': 'in the', 'desc': 'Spare parts, tools, and complex monitoring consoles fill this room. To the west is the engine room.',
                           'exits': {'w': 15}})
        world.insert( 18, {'visible': True, 'name': 'South fuel cell storage', 'prefix': 'in the', 'desc': 'This room is filled with empty fuel cells. The only exit is to the north.',
                           'exits': {'n': 15}})
        world.insert( 19, {'visible': True, 'name': 'Hangar Elevator Bay', 'prefix': 'at the', 'desc': 'The elevator goes up to the Main Deck. To the east is a wide entrance to the Hangar.',
                           'exits': {'u': 9, 'e': 20}})
        ...
        world.insert( 27, {'visible': True, 'name': 'Armory supply room', 'prefix': 'in the',
                           'desc': 'This room contains many strange devices. The exit is to the west.', 'exits': {'w': 25}})
        world.insert( 28, {'visible': True, 'name': 'Quarters Elevator Bay', 'prefix': 'at the',
                           'desc': 'This elevator goes up to the Main Deck. To the north is the lounge.', 'exits': {'n': 29, 'u': 13}})
