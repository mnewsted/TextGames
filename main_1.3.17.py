...
# text_games
# version 1.3.17
# description: enhanced flavor text
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        things.append({'name': 'phaser', 'prefix': 'a',
                       ...
                       'location': 26, 'on_person': False, 'moveable': True, 'is_weapon': True, 'damage': 30, 'hit_bonus': 40})
        ...
        things.append({'name': 'retina scanner', 'prefix': 'a', 'description': 'The scanner is built-into a panel next to the elevator door. '
                       'It sits at about eye-level and emits a dull red glow.',
