...
# text_games
# version 1.3.12
# description: bridge partway complete
...
def do_event(event_id, current_room):
    ...
    if game_choice == '1':
        ...
        if event_id in [0, 5, 6, 7, 10, 14, 16, 18, 19, 22, 27]:
            print(events[event_id]['first_time_text'])
            events[event_id]['done'] = True
        # use stimpack
        if event_id in [1]:
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        intro_text = ('*** Welcome to Space adventure ***\n\n'
                      ...
                      'While happily cleaning the lounge, you overheard that something got into your ship. The last thing you remember was getting hit hard on the head.\n\n'
        ...
        world.insert( 13, {'visible': True, 'name': 'Main Deck Elevator Bay 1', 'prefix': 'at',
                          'desc': 'The elevator goes down to Crew Quarters, but it require a keycard to activate it. To the east is a widening hallway.', 'exits': {'e': 12}})
        ...
        world.insert( 27, {'visible': True, 'name': 'Armory supply room', 'prefix': 'in the',
                           ...
                           'exits': {'w': 25}})
        world.insert( 28, {'visible': False, 'name': 'Quarters Elevator Bay 3', 'prefix': 'at',
        ...
        world.insert( 33, {'visible': True, 'name': 'Quarters Elevator Bay 1', 'prefix': 'at',
                           'desc': 'This elevator goes up to the Bridge, but it require a keycard to activate it. To the south is the observation deck.',
                           'exits': {'s': 32}})
        world.insert( 34, {'visible': True, 'name': 'Quarters Elevator Bay 2', 'prefix': 'at',
                           'desc': 'This elevator goes down to the Mess Hall and Medical Services, but it require a keycard to activate it. The observation deck is to the north.',
                           'exits': {'n': 32}})
        world.insert( 35, {'visible': True, 'name': 'Mess & Medical Elevator Bay', 'prefix': 'at the',
        ...
        things.append({'name': 'corpse', 'prefix': 'a',
                       'description': 'The body of one of your crewmates lies on the floor, contorted in an unatural pose. Every inch of their body is covered in a wet, dark gray-green substance. '
        ...
        things.append({'name': 'digipad5', 'prefix': 'a',
                       'description': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates.'
                                      '\n\tI saw Jackson from Combat Services drop dead. Once she did, a jade crystal coating formed over her skin.'
                                      '\n\tOthers just collapsed. But some went into zombie mode and started attacking. -A',
        ...
        things.append({'name': 'scalpel', 'prefix': 'a',
                       'description': 'The blade is short but exceedingly sharp. It would be very effective at a targeted procedure, but it would also do a lot of damage if it connected.',
        ...
        things.append({'name': 'digipad3', 'prefix': 'a',
                       'description': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates.'
                                       ...
                                       '\n\tassembled from three parts stored in closets on the ship. How is that secure? -M',
                      'location': 24, 'on_person': False, 'moveable': True, 'is_weapon': False})
        things.append({'name': 'phaser', 'prefix': 'a',
                       'description': 'The V-8 phaser pistol is a reliable mid- to close-range weapon.',
                       'location': 42, 'on_person': False, 'moveable': True, 'is_weapon': True, 'damage': 25, 'hit_bonus': 40})
        ...
        events.insert(10, {'id': 10, 'done': False, 'room': 999, 'item_name': 'digipad5',
                          'first_time_text': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates.'
                                      ...
                                      'But some went into zombie mode and started attacking. -A',
                          'already_done_text': 'The digipad reads:'
                                      '\n\tI saw Jackson from Combat Services drop dead. Once she did, a jade crystal coating formed over her skin.\n\tOthers just collapsed.'
                                      'But some went into zombie mode and started attacking. -A'})
        ...
        creatures.append({'id': 0, 'name': 'Prison guard',
                          ...
                          'room': 1, 'max_hp': 40, 'current_hp': 1, 'is_dead': False, 'is_hostile': False,
                          'status_neutral': 'It isn\'t interested in you.', 'status_hostile': 'It\'s very mad at you.',
        ...
        creatures.append({'id': 1, 'name': 'Spry zombie',
                          ...
                          'room': 30, 'max_hp': 60, 'current_hp': 1, 'is_dead': False, 'is_hostile': True,
                          'status_neutral': 'It isn\'t interested in you.', 'status_hostile': 'It\'s very mad at you.',
        ...
        creatures.append({'id': 2, 'name': 'Hulking guard',
                          ...
                          'room': 25, 'max_hp': 200, 'current_hp': 10, 'is_dead': False, 'is_hostile': True,
        ...
        creatures.append({'id': 3, 'name': 'Captain',
                          ...
                          'room': 43, 'max_hp': 100, 'current_hp': 40, 'is_dead': False, 'is_hostile': False,
