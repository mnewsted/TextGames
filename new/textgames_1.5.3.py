...
# TextGames
# version 1.5.3
# description: game 4 development created rooms
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        world.insert(11, {'visible': True, 'name': 'Pier', 'prefix': 'on the', 'name2': '',
                          ...
                          'exits': {'sw': 10, 'd': 12}})
        world.insert(12, {'visible': True, 'name': 'Surface', 'prefix': 'floating on the', 'name2': '',
        ...
        world.insert(13, {'visible': True, 'name': 'South shallows', 'prefix': 'in the', 'name2': '',
                          'desc': 'As you swim through the water, you see the shallows extend to the east and to the west. A cave network is accessible below.',
                          'exits': {'e': 14, 'w': 20, 'd': 21}})
        ...
        world.insert(20, {'visible': True, 'name': 'Southwest shallows', 'prefix': 'in the', 'name2': '',
                          'desc': 'This section of the lake is especially rocky. Even for you, it takes great concentration to navigate the shwllow waters. More open areas of the lake are visible to to the north and east. A tall, slender stone runs from the depths below to a flat area just above you.',
                          'exits': {'n': 19, 'e': 13, 'u': 33}})
        ...
        world.insert(30, {'visible': True, 'name': 'Sun-soaked log', 'prefix': 'on a', 'name2': '',
                          'desc': 'The bark of this wide log is somehow intact. It serves as a comfortable surface with direct sunlight. You can follow the log back down into the water.',
                          'exits': {'d': 14}})
        ...
        world.insert(33, {'visible': True, 'name': 'Stoney mini-mesa', 'prefix': 'on a', 'name2': '',
                          ...
                          'exits': {'d': 20}})
        world.insert(34, {'visible': False, 'name': 'Antechamber', 'prefix': 'in the', 'name2': '',
                          ...
                          'exits': {'u': 29, 's': 35}})
        world.insert(35, {'visible': True, 'name': 'Slimey core', 'prefix': 'in the', 'name2': '',
                          'desc': 'This wide cavern seems impossibly large. It must extend deep into the earth. Morose stone and decayed roots line the walls. The only exit is to the north.',
                          'exits': {'n': 34}})

        things.append({'name': 'note', 'prefix': 'a',
                       'description': 'After you smooth out the crumpled note, you see writing on the top half of the page. It reads:\n\nTo save the lake, go to the water\'s edge and don the ring of power.\nWhat ring? Only pure of heart can forge it with...\n', 'location': 0,
                       'on_person': False, 'moveable': True, 'is_weapon': False, 'base_damage': 0, 'damage': 0, 'hit_bonus': 0})
