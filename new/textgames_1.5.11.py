...
# TextGames
# version 1.5.11
# description: game 4 added endgame. need to remove testing nerf and add polish
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        things.append({'name': 'hex nut', 'prefix': 'a', 'description': 'This sturdy piece of steel has a threaded hole in the middle. The six-sided shape feels familiar. Where have you seen that before?',
