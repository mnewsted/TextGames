...
# TextGames
# version 1.5.7
# description: game 4 added mermaid room access puzzle
...
def do_multi_step_event(event_id):
    ...
    if game_choice == '4':
        if event_id in [6, 7, 8]:
            ...
            if all(shell_list):
                print('This time a loud creaking noise rumbles through the waters. Something has changed somewhere.')
                # new room
