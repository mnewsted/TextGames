...
# TextGames
# version 1.5.1
# description: game 4 development started
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        world.insert(0, {'visible': True, 'name': 'Foyer', 'prefix': 'in the', 'name2': '',
                         'desc': 'This entryway is just inside the front door of your home. Most of the house is accessible from here. The kitchen lies to the west, the living room is south, a stairway leads to the second-level rooms, '
                                 'and a door that leads to the garage is east. On the northern wall is the front door.',
                         'exits': {'n': 9, 'w': 1, 'e': 5, 'u':6}})
        world.insert(1, {'visible': True, 'name': 'Kitchen', 'prefix': 'in the', 'name2': '',
                         'desc': 'The décor in the kitchen is dated, but functional. The dining room is to the south, and the foyer opens to the east.',
                         'exits': {'e': 0, 's': 3}})
        world.insert(2, {'visible': True, 'name': 'Exit', 'prefix': 'out the', 'name2': '', 'desc': 'End description', 'exits': {}})
        world.insert(3, {'visible': True, 'name': 'Dining room', 'prefix': 'in the', 'name2': '',
                         'desc': 'Many happy meals were shared at the table in this room. It connects to the kitchen to the north.',
                         'exits': {'n': 1}})
        ...
        world.insert(5, {'visible': True, 'name': 'Garage', 'prefix': 'in the', 'name2': '',
                         'desc': 'The garage is filled with a musty smell. Tools and spare car parts line the walls. The door back into the house is to the west. The door to the outside seems to be jammed.',
                         'exits': {'w': 0}})
        ...
        world.insert(9, {'visible': True, 'name': 'Street', 'prefix': 'on the', 'name2': '',
                         'desc': 'A few trees line this quiet single-lane road that winds past your house. Your front door is to the south. From the north you can hear the water lap at the shore of the lake.',
                         'exits': {'s': 0, 'n': 2}})

        things.append({'name': 'note', 'prefix': 'a',
                       'description': 'After you smooth out the crumpled note, you see writing on the top half of the page.', 'location': 0,
