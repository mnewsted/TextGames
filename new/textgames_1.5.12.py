...
# TextGames
# version 1.5.12
# description: game 4 added flavor text, removed nerf
    ...
    if game_choice == '3':
        ...
        if (current_room in [30, 31, 32, 33]) and locale_visited == False:
            ...
            if special_chance >= 67: # harm
                ...
                special_damage = random.randrange(1, 10) # 1-9 damage
                ...
                special_heal = random.randrange(1, 10) # 1-9 heal
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        events.insert(22, {'id': 22, 'done': False, 'room': 999, 'item_name': 'half note',
