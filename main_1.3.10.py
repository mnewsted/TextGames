...
# text_games
# version 1.3.10
# description: added mess level events, items, etc.
...
def do_event(event_id, current_room):
    ...
    if game_choice == '1':
        ...
        if event_id in [0, 5, 6, 7, 10, 14, 16, 18]:
            print(events[event_id]['first_time_text'])
            events[event_id]['done'] = True
        # use stimpack
        if event_id in [1]:
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        world.insert( 35, {'visible': True, 'name': 'Mess & Medical Elevator Bay', 'prefix': 'at the',
                           'desc': 'This elevator goes up to the Quarters. To the east is the mess hall. South is a room called Medical Services A.',
        ...
        things.append({'name': 'mayonnaise', 'prefix': 'a', 'description': 'The large jar of eggy, white, goop is still half-full.',
                        'location': 40, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'pear powder', 'prefix': 'a', 'description': 'A hand-written label describes the sparkly, yellow granules inside this see-through flavor pouch.',
                        'location': 40, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        ...
        creatures.append({'id': 0, 'name': 'Prison guard',
                          ...
                          'room': 1, 'max_hp': 40, 'current_hp': 1, 'is_dead': False, 'is_hostile': True,
                          'status_neutral': 'It isn\'t interested in you.', 'status_hostile': 'It\'s very mad at you.',
                          'damage': 10, 'hit_bonus': 10, 'attack_chance': 65, 'is_fatigued': False, 'death_event': 3})
        creatures.append({'id': 1, 'name': 'Sleepy zombie',
                          'description': 'This zombified crewmate is lithe and unpredictable. It has that familair green skin and murky eyes. Blood and bits of flesh are visible on the tips of its fingers.',
