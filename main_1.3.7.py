...
# text_games
# version 1.3.7
# description: adding story elements
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        exit_room = 99
        player_hp = 100
        intro_text = ('You are on the custodial crew of an intergalactic starship. Your ship\'s mission was to respond to a distress signal sent by another ship in a newly discovered planetary system.\n'
        ...
        things.append({'name': 'Breathing mask', 'prefix': 'a', 'description': 'The compact device looks like it would fit nicely on your face if you pick it up or use it.',
                       'location': 3, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'digipad', 'prefix': 'a',
                       'description': 'Like other digipads you\'ve seen, this one contains messages sent by your crewmates. It will update periodically'
