...
def show_help():
    ...
    print('')
    print('A few notes about creatures: They can be friendly or aggressive (hostile).')
    print('If you use a weapon on a creature, it will become hostile.')
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        world.insert(3, {'visible': True, 'name': 'Storage nook', 'prefix': 'in a', 'name2': '',
                         ...
                         'exits': {'s': 2}})
        world.insert(4, {'visible': True, 'name': 'Detention Level Elevator Bay', 'prefix': 'at the', 'name2': ' (to Main Deck)',
                         'desc': 'The elevator goes up to the Main Deck, but it requires a keycard to activate it. The detention hallway is to the east.',
                         'exits': {'e': 1}})
        world.insert( 5, {'visible': False, 'name': 'Main Deck Elevator Bay 5', 'prefix': 'at', 'name2': ' (to Detention Level)',
        ...
        world.insert( 14, {'visible': True, 'name': 'Engine Room Elevator Bay', 'prefix': 'at the', 'name2': ' (to Main Deck)',
        ...
        world.insert( 33, {'visible': True, 'name': 'Quarters Elevator Bay 1', 'prefix': 'at', 'name2': ' (to Bridge)',
                           ...
                           'exits': {'s': 32}})
        world.insert( 34, {'visible': True, 'name': 'Quarters Elevator Bay 2', 'prefix': 'at', 'name2': ' (to Mess & Medical)',
                           ...
                           'exits': {'n': 32}})
        world.insert( 35, {'visible': True, 'name': 'Mess Hall and Medical Services Elevator Bay', 'prefix': 'at the', 'name2': ' (to Quarters)',
        ...
        things.append({'name': 'food tray', 'prefix': 'a', 'description': 'The empty food tray has some heft to it. The metal edge looks mean.',
                       'location': 0, 'on_person': False, 'moveable': True, 'is_weapon': True, 'base_damage': 10, 'damage': 10, 'hit_bonus': 25})
        ...
        things.append({'name': 'wrench', 'prefix': 'a',
                       ...
                       'location': 17, 'on_person': False, 'moveable': True, 'is_weapon': True, 'base_damage': 15, 'damage': 15, 'hit_bonus': 30})
        ...
        things.append({'name': 'scalpel', 'prefix': 'a',
                       ...
                       'location': 37, 'on_person': False, 'moveable': True, 'is_weapon': True, 'base_damage': 10, 'damage': 25,
                       'hit_bonus': 15})
        things.append({'name': 'fallen soldier', 'prefix': 'a',
                       'description': 'This dead crewmate is bent backwards, leaning on the countertop. They have the insignia and fatigues of a tactical combat specialist. '
        ...
        things.append({'name': 'phaser', 'prefix': 'a',
                       ...
                       'location': 26, 'on_person': False, 'moveable': True, 'is_weapon': True, 'base_damage': 20, 'damage': 25, 'hit_bonus': 40})
        ...
        things.append({'name': 'retina scanner', 'prefix': 'a', 'description': 'The scanner is built-into a panel next to the elevator door. '
                       'It sits at about eye-level and sheds a dull red glow.',
                       'location': 11, 'on_person': False, 'moveable': False, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'phaser booster', 'prefix': 'a', 'description': 'The booster is a shiny gray widget. In small print it reads, '
                                                                               '"Turns your V-8 into a V-9!"',
                       'location': 6, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        things.append({'name': 'medium stimpack', 'prefix': 'a', 'description': 'The double vials have red hearts etched into their sides. There is only one needle, thankfully.',
                       'location': 30, 'on_person': False, 'moveable': True, 'is_weapon': False, 'damage': 0, 'hit_bonus': 0})
        ...
        events.insert(40, {'id': 40, 'done': False, 'room': 999, 'item_name': 'medium stimpack',
                          'first_time_text': 'You stick the medium stimpack into your belly. A warm glow courses from your midsection to your extremeties. You feel much better.',
        ...
        creatures.append({'id': 1, 'name': 'Spry zombie',
                          ...
                          'status_neutral': 'It isn\'t interested in you.', 'status_hostile': 'It\'s very mad at you.',
                          'damage': 15, 'hit_bonus': 10, 'attack_chance': 70, 'is_fatigued': False, 'death_event': 12, 'was_seen': False,
        ...
        creatures.append({'id': 3, 'name': 'Captain',
                          ...
                          'damage': 15, 'hit_bonus': 10, 'attack_chance': 70, 'is_fatigued': False, 'death_event': 31, 'was_seen': False,
