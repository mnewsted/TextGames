...
# text_games
# version 1.3.14
# description: space adventure updated after testing
...
def load_game(choice):
    ...
    if choice == '1':
        ...
        creatures.append({'id': 1, 'name': 'Spry zombie',
                          ...
                          'status_neutral': 'It isn\'t interested in you.', 'status_hostile': 'It\'s very mad at you.',
                          'damage': 15, 'hit_bonus': 15, 'attack_chance': 70, 'is_fatigued': False, 'death_event': 12})
        creatures.append({'id': 2, 'name': 'Hulking guard',
                          'description': 'The guard is a head taller than you, with milky eyes and a ghoulish complexion. Even though its wide body moves slowly, you sense it holds the force of a great catapult within. '
        ...
        creatures.append({'id': 3, 'name': 'Captain',
                          ...
                          'status_neutral': 'They appear disinterested in you.', 'status_hostile': 'They takes aim at you.',
                          'damage': 15, 'hit_bonus': 20, 'attack_chance': 80, 'is_fatigued': False, 'death_event': 31})
