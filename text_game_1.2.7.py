...
def show_help():
    ...
    print('')
    print('Note: When typing a command, enter one action word then press ENTER.')
    print('Example: Type \'use\' instead of \'use apple.\'')
    print('You will be asked what item you want to use.')
    print('COMMANDS'.center(72, '='))
